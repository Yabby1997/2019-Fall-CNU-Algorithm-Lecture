...
public class AppController {
	...
	private void inputAndMakeGraph() {
		...
		this.setGraph(new DirectedAdjacencyListGraph<Edge>(numberOfVertices));											//graph는 입력받은  만큼의 vertex를 갖는다. 입력받은 vertex만큼의 행과 열을 가져서 각 요소가 인접성을 나타냄.
